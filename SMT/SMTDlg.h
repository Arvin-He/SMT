...
public:
	...
	afx_msg void OnBnClickedStageXGohomeBackBtn();
	afx_msg void OnBnClickedStageYGohomeBackBtn();
	afx_msg void OnBnClickedCcdXGohomeBackBtn();
	afx_msg void OnBnClickedCcdZGohomeBackBtn();
	afx_msg void OnBnClickedStageXGohomeForwardBtn();
	afx_msg void OnBnClickedStageYGohomeForwardBtn();
	afx_msg void OnBnClickedCcdXGohomeForwardBtn();
	afx_msg void OnBnClickedCcdZGohomeForwardBtn();
};
